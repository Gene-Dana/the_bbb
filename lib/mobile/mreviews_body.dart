...
/// Add what it does
/// {@endtemplate}
class mReviewsBody extends StatefulWidget {
  /// {@macro reviews_body}
  mReviewsBody({super.key, required this.reviews});

  final List<Review> reviews;

  @override
  State<mReviewsBody> createState() => _mReviewsBodyState();
}

class _mReviewsBodyState extends State<mReviewsBody> {
